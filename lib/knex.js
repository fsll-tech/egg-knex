...
const SUPPORTS = [ 'sqlite', 'mysql', 'mysql2', 'oracledb', 'mssql', 'maria', 'mariasql', 'mariadb', 'pg', 'postgresql', 'gs', 'opengauss' ];

const isSupport = dialect => SUPPORTS.indexOf(dialect) !== -1;

const canExplain = dialect => [ 'mysql', 'mysql2', 'maria', 'mariasql', 'mariadb', 'opengauss' ].includes(dialect);
